function [Data_f, Param_f] = EM2(Data, Param)
%{ 
...
formatSpec = 'iteration: %d, error: %2.4f, \nmu1: [%2.4f %2.4f %2.4f %2.4f %2.4f %2.4f %2.4f %2.4f %2.4f %2.4f %2.4f %2.4f %2.4f %2.4f %2.4f], \nmu2: [%2.4f %2.4f %2.4f %2.4f %2.4f %2.4f %2.4f %2.4f %2.4f %2.4f %2.4f %2.4f %2.4f %2.4f %2.4f] \n';

while shift > epsilon
    iter = iter + 1;

    % E-step
    Data_ = expectation2(Data, Param);
    
    % M-step
    Param_ = maximization2(Data_, Param);
    
    % calculate the distance/error from the previous set of params
    shift = calc_distance2(Param, Param_);
